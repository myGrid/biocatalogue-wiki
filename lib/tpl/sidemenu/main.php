...
<div id="wrapper">
  <div class="dokuwiki">
    ...
    <div class="stylehead">
      <div class="header">
        <div class="pagename" style="font-size: 0.9em;">
          <!--[[<?php tpl_link(wl($ID,'do=backlink'),tpl_pagetitle($ID,true))?>]]-->
          <!--[<?php tpl_link(wl($ID),tpl_pagetitle($ID,true))?>]-->
          <a href="http://www.biocatalogue.org"><< Go to www.biocatalogue.org</a>
        </div>
        <div class="logo">
          <!--<?php tpl_link(wl(),$conf['title'],'name="dokuwiki__top" accesskey="h" title="[ALT+H]"')?>-->
          <a href="doku.php?id=public" name="dokuwiki__top" accesskey="h" title="[ALT+H]"><img src="<?php echo DOKU_TPL?>images/logo_wiki.gif" alt="BioCatalogue logo" /></a>
        </div>
      </div>
